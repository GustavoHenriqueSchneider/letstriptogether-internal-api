...
public class SmtpClientWrapperTests
{
    ...
    public async Task SendMailAsync_WithMessage_ShouldDelegateToSmtpClient()
    {
        ...
        // Ensure the pickup directory exists
        ...
        // Act & Assert
        // Using pickup directory method, the email will be saved to disk instead of being sent
        // This provides code coverage without requiring a real SMTP server
