...
[TestFixture]
public class AdminGetGroupMemberAllDestinationVotesByIdHandlerTests : TestBase
{
    private AdminGetGroupMemberAllDestinationVotesByIdHandler _handler = null!;
    ...
    public async Task SetUp()
    {
        ...
        _handler = new AdminGetGroupMemberAllDestinationVotesByIdHandler(
