...
namespace Application.UnitTests.UseCases.v1.Admin.AdminGroupMember.Query.AdminGetAllGroupMembersById;

[TestFixture]
public class AdminGetAllGroupMembersByIdHandlerTests : TestBase
{
    private AdminGetAllGroupMembersByIdHandler _handler = null!;
    ...
    public async Task SetUp()
    {
        ...
        _handler = new AdminGetAllGroupMembersByIdHandler(_groupMemberRepository, _groupRepository);
    }

    [Test]
    public async Task Handle_WithMembers_ShouldReturnPaginatedResults()
    {
        // Arrange
