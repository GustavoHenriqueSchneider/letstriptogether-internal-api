...
namespace WebApi.Migrations
{
    ...
    public partial class AddExampleData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            var resourceName = "Infrastructure.Datasets.destinations.json";
            ...
            var realDestinations = new List<(Guid Id, string Address, string Description, string Image)>();
            ...
            foreach (var cityElement in jsonDoc.RootElement.EnumerateArray())
            {
                ...
                var cityImage = cityElement.TryGetProperty("image", out var imageElement) ? imageElement.GetString() ?? string.Empty : string.Empty;
                
                var destinationId = Guid.NewGuid();
                realDestinations.Add((destinationId, cityName, cityDescription, cityImage));
            ...
            {
                var valuesArray = new object[destinationRows.Count, 6];
                for (int i = 0; i < destinationRows.Count; i++)
                {
                    ...
                    valuesArray[i, 5] = destinationRows[i][5];
                }
                
                migrationBuilder.InsertData(
                    table: "Destinations",
                    columns: new[] { "Id", "Address", "Description", "Image", "CreatedAt", "UpdatedAt" },
                    values: valuesArray);
            }
